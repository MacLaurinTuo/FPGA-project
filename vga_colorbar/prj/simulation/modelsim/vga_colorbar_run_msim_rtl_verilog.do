...
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_colorbar/rtl {E:/code/workspace_FPGA/vga_colorbar/rtl/vga_colorbar.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_colorbar/rtl {E:/code/workspace_FPGA/vga_colorbar/rtl/vga_pic.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_colorbar/rtl {E:/code/workspace_FPGA/vga_colorbar/rtl/vga_ctrl.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_colorbar/prj/ipcore/clk_gen {E:/code/workspace_FPGA/vga_colorbar/prj/ipcore/clk_gen/clk_gen.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_colorbar/prj/db {E:/code/workspace_FPGA/vga_colorbar/prj/db/clk_gen_altpll.v}

vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_colorbar/prj/../sim {E:/code/workspace_FPGA/vga_colorbar/prj/../sim/tb_vga_colorbar.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  tb_vga_colorbar
