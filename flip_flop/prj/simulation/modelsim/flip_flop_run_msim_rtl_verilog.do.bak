...
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/flip_flop/rtl {E:/code/workspace_FPGA/flip_flop/rtl/flip_flop.v}

vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/flip_flop/prj/../sim {E:/code/workspace_FPGA/flip_flop/prj/../sim/tb_flip_flop.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  tb_flip_flop
