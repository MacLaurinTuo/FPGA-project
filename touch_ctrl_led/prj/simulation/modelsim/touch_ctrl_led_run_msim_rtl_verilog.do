...
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/touch_ctrl_led/rtl {E:/code/workspace_FPGA/touch_ctrl_led/rtl/touch_ctrl_led.v}

vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/touch_ctrl_led/prj/../sim {E:/code/workspace_FPGA/touch_ctrl_led/prj/../sim/tb_touch_ctrl_led.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  tb_touch_ctrl_led
