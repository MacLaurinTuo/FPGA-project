...
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/half_adder/rtl {E:/code/workspace_FPGA/half_adder/rtl/half_adder.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/full_adder/rtl {E:/code/workspace_FPGA/full_adder/rtl/full_adder.v}

vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/full_adder/quartus_prj/../sim {E:/code/workspace_FPGA/full_adder/quartus_prj/../sim/tb_full_adder.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  tb_full_adder
