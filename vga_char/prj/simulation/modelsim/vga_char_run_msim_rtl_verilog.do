...
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_char/rtl {E:/code/workspace_FPGA/vga_char/rtl/vga_pic.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_char/rtl {E:/code/workspace_FPGA/vga_char/rtl/vga_ctrl.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_char/rtl {E:/code/workspace_FPGA/vga_char/rtl/vga_char.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_char/prj/ipcore/clk_gen {E:/code/workspace_FPGA/vga_char/prj/ipcore/clk_gen/clk_gen.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_char/prj/db {E:/code/workspace_FPGA/vga_char/prj/db/clk_gen_altpll.v}

vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/vga_char/prj/../sim {E:/code/workspace_FPGA/vga_char/prj/../sim/tb_vga_char.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  tb_vga_char
