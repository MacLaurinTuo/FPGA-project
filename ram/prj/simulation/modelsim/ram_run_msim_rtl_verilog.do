...
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/ram/rtl {E:/code/workspace_FPGA/ram/rtl/ram_ctrl.v}

vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/ram/prj/../sim {E:/code/workspace_FPGA/ram/prj/../sim/tb_ram_ctrl.v}
vlog -vlog01compat -work work +incdir+E:/code/workspace_FPGA/ram/prj/ipcore_dir/ram_8x256_one {E:/code/workspace_FPGA/ram/prj/ipcore_dir/ram_8x256_one/ram_8x256_one.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_ram_ctrl
